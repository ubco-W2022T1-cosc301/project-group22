...
Although action games have had the most sales overall, certain genres like sports and shooter games have had short time frames of around a year where they peak in popularity momentarily and surpass other genres in sales. These trends are not necessarily consistent with worldly events like the Olympics and are most likely caused by supply and demand since we saw that sales is coherent with the number of games made in a genre. This shows that there’s more going on behind the scenes when a game genre is trending for a short period of time before sales rapidly decrease.
